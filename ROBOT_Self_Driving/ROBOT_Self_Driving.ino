...
void loop() {
  ...
  while ((subscription = mqtt.readSubscription(5000))) {
    if (subscription == &direction_control) {
      ...
      else if(strcmp((char *)direction_control.lastread, "6") == 0){
        Serial.println("Left");
        Left();
        
      }
      else if(strcmp((char *)direction_control.lastread, "7") == 0){
        Serial.println("Right");
        Right();
        
      }
      else if(strcmp((char *)direction_control.lastread, "8") == 0){
        Serial.println("Backwards");
        Backwards();
